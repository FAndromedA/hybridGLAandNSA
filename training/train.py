...
from models.hybrid_model import HybridModel, HybridBlock 
...
def convert_llama_weights(
    ...
    model.model.embeddings.weight.data[:vocab_size].copy(llama.model.embed_tokens.weight[:vocab_size])
    ...
    for i in range(config.num_hidden_layers):
        if hasattr(model.model.layers[i], 'attn_norm'):
            ...
            model.model.layers[i].attn_norm.eps = llama.model.layers[i].input_layernorm.eps
        ...
        if hasattr(llama.model.layer[i].self_attn.q_proj, 'bias') and hasattr(model.model.layers[i].attn.q_proj, 'bias'):
        ...
        if hasattr(llama.model.layer[i].self_attn.k_proj, 'bias') and hasattr(model.model.layers[i].attn.k_proj, 'bias'):
        ...
        if hasattr(llama.model.layer[i].self_attn.v_proj, 'bias') and hasattr(model.model.layers[i].attn.v_proj, 'bias'):
        ...
        if hasattr(llama.model.layer[i].self_attn.o_proj, 'bias') and hasattr(model.model.layers[i].attn.o_proj, 'bias'):
